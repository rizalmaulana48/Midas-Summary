...
<body style="background: linear-gradient(90deg, #3F5EFB 0%, #808080 100%);">
            ...
            <!-- Nested Row within Card Body -->
                ...
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Login User | Summary Midas</h1>
                  </div>
                  <form class="user" action="proses-login-user.php" method="post">
